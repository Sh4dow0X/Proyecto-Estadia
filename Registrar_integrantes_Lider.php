    ...
    <div class="Contenedor_Encabezado">
      ...
      <div class="Titulo_Contendor">
        <div class="Titulo_Titulo">
          <P style="font-family:arial narrow;font-size:17px;">MODULO DE SEGUIMIENTO DE PROYECTO INTEGRADOR</P>
        </div>
        <div class="Titulo_Titulo">
          <P style="color:red; font-size:16px;font-style:italic;font-family:arial narrow ">SITIO DEL LIDER</P>
        </div>
      </div>
      <br>
    ...
    <div class="Contenedor_Principal">
      <div class="Contenedor_Principal_Datos">
        ...
        <div class="FotoPerfil">
          ...
          <div class="Foto">
            <!-- TERMINA CODIGO PARA COLOCAR FOTO DE PERFIL-->
      ...
      <div class="Contenedor_Encabezado2">
        ...
        <!--TERMINA CODIGO PARA COLOCAR LA OPCIONES-->
        ...
        <div class="Cuadro_Registrar">
          <div class="Cuadro_Registrar2">
            ...
            <table class="Tabla">
              <form method="post" name="cargarDatosEstudiante" action="Registrar_integrantes_Lider.php">
