...
$resultado_descargar=mysqli_query($Conexion,"SELECT * FROM entregables
 ...
 echo '<script>';
          ...
          echo 'window.location.href="Entregables_Profesor_Notutor_dos.php";';
echo '</script>';
}
...
<form  action="Entregables_Profesor_Notutor_dos.php" method="post">
...
<form  method="post" action="Entregables_Profesor_Notutor_dos.php" >
...
<div class="ventana_datos" id="archivos" >
  <div class="cerrar" id="cerrar"> <a href="javascript:cerrar_descarga()"> <img src="Imagenes/cerrar.png"> </a></div>
    ...
    <form  method="post" action="Entregables_Profesor_Notutor_dos.php" enctype="multipart/form-data">
