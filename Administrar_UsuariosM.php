...
while($con=mysqli_fetch_array($resultado)){
  $N=$con['Nombre'];
  $maestro="SELECT* FROM maestros where ID='$id'";
...
$Consulta2="UPDATE maestros SET Nombre='$nombrem',Usuario='$usuariom',Clave='$pasm' WHERE ID = '$im'";
...
$Consulta3="DELETE FROM maestros WHERE ID = '$im'";
$resultado3=mysqli_query($Conexion,$Consulta3);



$Consulta4="INSERT INTO tutores (Nombre,Clave,Usuario) VALUES ('$nombrem','$pasm','$usuariom')";
...
<div class="Contenedor_Encabezado2">
  ...
  <form method="post" action="Administrar_UsuariosM.php">
    <table class="Tabla">
    <tr>
    ...
    <tr>
      ...
      <td> 
      <input class="BotonSubir" style="float:left;font-family:calibri" type="submit" name="CTutor" value="Cambiar a Tutor"> 
      </td>
    </tr>
    <?php } ?> 
