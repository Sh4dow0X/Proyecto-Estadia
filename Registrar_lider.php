...
<form  method="post" action="Registrar_lider.php">


<h5 style="font-family: calibri;">Datos del integrante</h5> 
<h6 style="font-family: calibri;">*Ingrese la matricula del lider y presion "Cargar datos"</h6> 
 <tr>
    <th>Matricula</th>
...
<tr>
    <th>Tutor</th>
    <td><input style="width:80%; font-family: calibri"  type="text" name="Tutor" value=" <?php  echo $Tutor; ?>"  </td>
  </tr>
  
 <tr>
    <th>Generación</th>
    <td><input style="width:80%; font-family: calibri" class="agregar_datos" type="text" name="Generacion" value=" <?php  echo $Gen; ?>""maxlength="30" ></td>
  </tr>
